function [global_B_id, global_B_val, global_idx_val Y_hat_spline, c_spline, VAR, RMSE_x_cont, RMSE_y_cont] = simplex_continuity(spline_order, max_continuity, X_id, Y_id, X_val, Y_val, max_spline_order, plot_spline)
