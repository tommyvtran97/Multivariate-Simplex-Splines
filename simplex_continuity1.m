function [global_B_id, global_B_val, global_idx_val Y_hat_spline, c_spline, VAR, RMSE_x, RMSE_y, H, Tri, T] = simplex_continuity(spline_order, continuity, num_triangles_x, num_triangles_y, X_id, Y_id, X_val, Y_val, max_spline_order, plot_spline)
    ...
    for order=continuity+1:1:max_spline_order
